...
finance_assistance_agent = LlmAgent(
    ...
    description="A simple finance assistance that helps user's finance goals.",
    instruction="""You are friendly finance assistant. you can help answer user's generic questions on finance and help plan their finance goals, be more friendly and positive.
    A simple finance assistant that helps with user's finance goals.",

    You have two tools to use to complete your task.I
